...
func Register(s *mcp.Server, d Deps) {
	...
	mcp.AddTool(s, &mcp.Tool{
		...
		Description: createMergeRequestNoteDescription,
		Annotations: &mcp.ToolAnnotations{DestructiveHint: gitlab.Ptr(false)},
	}, safe(d, createMergeRequestNote(d)))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "update_merge_request",
		Description: updateMergeRequestDescription,
		Annotations: &mcp.ToolAnnotations{DestructiveHint: gitlab.Ptr(true)},
	}, safe(d, updateMergeRequest(d)))

	mcp.AddTool(s, &mcp.Tool{
		Name:        "merge_merge_request",
		Description: mergeMergeRequestDescription,
		Annotations: &mcp.ToolAnnotations{DestructiveHint: gitlab.Ptr(true)},
	}, safe(d, mergeMergeRequest(d)))
