...
func TestStdioWirePaths(t *testing.T) {
	...
	sort.Strings(names)
	wantNames := []string{"commit_files", "compare_refs", "create_branch", "create_merge_request", "create_merge_request_note", "create_or_update_file", "get_commit", "get_file_contents", "get_merge_request", "get_merge_request_diffs", "get_project", "list_branches", "list_commits", "list_merge_request_notes", "list_merge_requests", "list_projects", "list_repository_tree", "update_merge_request", "whoami"}
