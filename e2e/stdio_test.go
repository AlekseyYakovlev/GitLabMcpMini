...
func TestStdioWirePaths(t *testing.T) {
	...
	sort.Strings(names)
	wantNames := []string{"commit_files", "compare_refs", "create_branch", "create_or_update_file", "get_commit", "get_file_contents", "get_project", "list_branches", "list_commits", "list_projects", "list_repository_tree", "whoami"}
